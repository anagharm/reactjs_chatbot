...
function App() {
  ...
  const [dateTime, setDateTime] = useState(`${days[day]},${months[month]}  ${day} ${year}`); //using the useState hook to get the data from the local date and set it to the dateTime variable
